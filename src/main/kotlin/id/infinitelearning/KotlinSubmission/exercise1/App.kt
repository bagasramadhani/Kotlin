...
fun myProfile() {
        val namadepan = "Bagas"
        val namabelakang = "Ramadhani"
        val Umur = 21
        val tahun = "tahun"
        val sekolah = "Universitas Amikom Purwokerto"
...
fun main() {
     ...
     *
     */
    groupDetail(12, listOf("Bagas", "Andis", "Gilang", "Ali", "Tetuko", "Mira", "Nabilla", "Novianta", "Lisa", "Anabil", "Glency", "Tirani"), "Morning")
